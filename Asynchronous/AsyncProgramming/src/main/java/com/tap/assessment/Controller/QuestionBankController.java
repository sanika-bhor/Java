...
public class QuestionBankController {
    ...
    public CompletableFuture<Boolean> addQuestion(@RequestBody Question question)   
    {  
        return questionBankService.insert(question);  
    }
   
    @DeleteMapping("/questionbank/deleteQuestion/{id}")  
    public CompletableFuture<Boolean> deleteProduct(@PathVariable("id") int id)   
    {  
         return questionBankService.delete(id);  
    }  

    @PutMapping("/questionbank/updateQuestion/{id}")  
    private CompletableFuture<Boolean> updateProduct(@PathVariable("id") int id, @RequestBody Question question)   
    {  
